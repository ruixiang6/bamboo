...
#define CDC_BULK_OUT_EP                                 MSS_USB_RX_EP_1
#define CDC_BULK_IN_EP                                  MSS_USB_TX_EP_1
#define CDC_INTR_IN_EP                                  MSS_USB_TX_EP_2

/*MSS USB core FIFO address for endpoints used by CDC class*/
#define CDC_BULK_IN_EP_FIFO_ADDR                        0x200u
#define CDC_BULK_OUT_EP_FIFO_ADDR                       0x1000u
#define CDC_INTR_IN_EP_FIFO_ADDR                        0x50u

/*MSS USB core FIFO size for endpoints used by CDC class*/
#define CDC_BULK_IN_EP_FIFO_SIZE                        2048u
#define CDC_BULK_OUT_EP_FIFO_SIZE                       4096u
#define CDC_INTR_IN_EP_FIFO_SIZE                        64u

/*Maximum packet size for endpoints used by CDC class*/
#define CDC_BULK_IN_EP_MAX_PKT_SIZE                     512u
#define CDC_BULK_OUT_EP_MAX_PKT_SIZE                    512u
#define CDC_INTR_IN_EP_MAX_PKT_SIZE                     64u
