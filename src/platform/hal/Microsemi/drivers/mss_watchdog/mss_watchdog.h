 ...
 * register.
 */
#define MSS_WDOG_TIMEOUT_IRQ_ENABLE_BIT_MASK  (uint32_t)0x00000002U
...
/***************************************************************************//**
  ...
  register.
 */
#define MSS_WDOG_WAKEUP_IRQ_ENABLE_BIT_MASK   (uint32_t)0x00000001U
...
static __INLINE void MSS_WD_init(void)
{
	...
	/* Enable watchdog and interrupt mode. */
    SYSREG->WDOG_CR |= 0x00000003;
    
	/* Clear any existing interrupts. */
    WATCHDOG->WDOGRIS = MSS_WDOG_TIMEOUT_IRQ_CLEAR_BIT_MASK|MSS_WDOG_WAKEUP_IRQ_CLEAR_BIT_MASK;
    
    /* Disable interrupts. */
    WATCHDOG->WDOGCONTROL &= ~(MSS_WDOG_WAKEUP_IRQ_ENABLE_BIT_MASK|MSS_WDOG_TIMEOUT_IRQ_ENABLE_BIT_MASK);
