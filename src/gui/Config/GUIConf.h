...
#define GUI_DEFAULT_FONT          &GUI_Font8_1//
#define GUI_ALLOC_SIZE            10240//16384  /* Size of dynamic memory ... For WM and memory devices*/
...
#define GUI_DEBUG_LEVEL GUI_DEBUG_LEVEL_NOCHECK//GUI_DEBUG_LEVEL_LOG_ALL
