...
#include <gui_1.h>				/* qhw edit*/

#define UNUSED_LCD_CONTROL_DRAW	0
...
*/
  ...
  #define LCD_INIT_CONTROLLER()			LCD_InitPanel()
#endif
...
void LCD_L0_SetPixelIndex(int x, int y, int PixelIndex) {
 ...
 if ((x < LCD_XSIZE) && (y < LCD_YSIZE)) {
        //*(volatile uint16_t *)(LCD_RAM_BASE_ADDR + 2*(xPhys + LCD_XSIZE * yPhys)) = (unsigned short)PixelIndex;
		hal_lcd_set_pixel(x, y, (unsigned short)PixelIndex);
 	}
}
...
unsigned int LCD_L0_GetPixelIndex(int x, int y) {
  ...
  /* Write into hardware ... Adapt to your system */
    ...
    if ((x < LCD_XSIZE) && (y < LCD_XSIZE)) {
        //PixelIndex = *((volatile uint16_t *)(LCD_RAM_BASE_ADDR + 2*(xPhys + LCD_XSIZE * yPhys))); 
