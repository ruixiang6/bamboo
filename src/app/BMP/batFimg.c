...
extern GUI_CONST_STORAGE GUI_BITMAP bmbatFimg;
...
*/
static GUI_CONST_STORAGE GUI_COLOR _ColorsbatFimg[] = {
  0x000000, 0xFFFFFF
};

#endif

static GUI_CONST_STORAGE GUI_LOGPALETTE _PalbatFimg = {
  2,  // Number of entries
  0,  // No transparency
  NULL
};

static GUI_CONST_STORAGE unsigned char _acbatFimg[] = {
  XXXXXXX_,
  XXXXXXXX,
  XXXXXXXX,
  XXXXXXX_
...
GUI_CONST_STORAGE GUI_BITMAP bmbatFimg = {
  8, // xSize
  4, // ySize
  1, // BytesPerLine
  1, // BitsPerPixel
  _acbatFimg,  // Pointer to picture data (indices)
  &_PalbatFimg   // Pointer to palette
};
