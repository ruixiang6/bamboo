...
extern GUI_CONST_STORAGE GUI_BITMAP bmspeakimg;
...
*/
static GUI_CONST_STORAGE GUI_COLOR _Colorsspeakimg[] = {
  0x000000, 0xFFFFFF
};

#endif

static GUI_CONST_STORAGE GUI_LOGPALETTE _Palspeakimg = {
  2,  // Number of entries
  0,  // No transparency
  NULL
};

static GUI_CONST_STORAGE unsigned char _acspeakimg[] = {
  ____XX__,
  ___X_X__,
  XXX__X__,
  X_X__X__,
...
GUI_CONST_STORAGE GUI_BITMAP bmspeakimg = {
  6, // xSize
  7, // ySize
  1, // BytesPerLine
  1, // BitsPerPixel
  _acspeakimg,  // Pointer to picture data (indices)
  &_Palspeakimg   // Pointer to palette
};
