...
extern GUI_CONST_STORAGE GUI_BITMAP bmbatEimg;
...
*/
static GUI_CONST_STORAGE GUI_COLOR _ColorsbatEimg[] = {
  0x000000, 0xFFFFFF
};

#endif

static GUI_CONST_STORAGE GUI_LOGPALETTE _PalbatEimg = {
  2,  // Number of entries
  0,  // No transparency
  NULL
};

static GUI_CONST_STORAGE unsigned char _acbatEimg[] = {
  XXXXXXX_,
  X_____XX,
  X_____XX,
  XXXXXXX_
...
GUI_CONST_STORAGE GUI_BITMAP bmbatEimg = {
  8, // xSize
  4, // ySize
  1, // BytesPerLine
  1, // BitsPerPixel
  _acbatEimg,  // Pointer to picture data (indices)
  &_PalbatEimg   // Pointer to palette
};
